...
function save(){
    ...
    i = 12;
    j = ['ms-per-coin-move','ms-per-player-move','frames-per-purple','orange-miss-select','audio-volume','max-time','wrap-select','y-margin','game-mode-select','max-points','purple-catch-select','move-keys','start-key'];
    do{
